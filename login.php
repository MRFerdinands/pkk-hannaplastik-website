...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;"><span class="text-primary"></span></h1>
    	<center><img alt="logo" src="assets/img/logo1.jpg" height="110" width="110"/><p>
...
block;"><a href="www.smknu3bws.sch.id">
...
<!-- END: Powered by Ipaddress.is -->
        <div class="text-center small mt-4">
            <p class="text-muted">Aplikasi kasir © <?php echo date('Y');?> - By : <a href="#" class="span text-primary">Adgrafika</a></p>
        </div>
    </div>
